...
This specific project contains two sections which include image processing and component detection. For the first section,  I will be using OpenCV to mask the image of the motherboard, and in the second section, I'll be using YOLOv11 to classify components from a PCB. 
